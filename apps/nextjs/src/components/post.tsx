...
const Post: React.FC<GetDiscussionOutput> = ({
  ...
  return (
    <>
      <div className="border-y-3 my-10px rounded-lg" style={{backgroundColor: "#EFF2FB", width: "70%", margin: "1.5rem auto", padding: "2rem"}}>
        {/* // TODO: when participant api is created, replace userId with the result of this API */}

        <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
          <h2 className="text-2xl font-bold" style={{marginBottom: "0", lineHeight: "1"}}>User {userId}</h2>
          <button style={{width: "20px"}}>
            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.2322 3.23223L16.7677 6.76777M14.7322 1.73223C15.7085 0.755922 17.2914 0.755922 18.2677 1.73223C19.244 2.70854 19.244 4.29146 18.2677 5.26777L4.5 19.0355H1V15.4644L14.7322 1.73223Z" stroke="#111827" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        </div>
      ...
      {modalVisible && (
        <div style={{position: "absolute", backgroundColor: "#EFF2FBCC", top: 0, left: 0, right: 0, bottom: 0}}>
        <div className="modal" style={{backgroundColor: "white", position: "absolute", top: "2rem", left: "2rem", right: "2rem", bottom: "2rem", margin: "10px;", borderRadius: "10px"}}>
          <div style={{display: "grid", gridTemplateColumns: "1fr 10fr 1fr", gridTemplateRows: "repeat(1, 1fr)", height: "100%"}}>
            <div className="left-two-thirds" style={{gridArea: "1 / 1 / 2 / 2"}}>
              <button className="exit-out" style={{padding: "1.5rem 1.5rem"}} onClick={closeModal}>
                X
              </button>
            </div>
            <div className="right-one-third" style={{gridArea: "1 / 2 / 2 / 3", display: "flex", flexDirection: "column", justifyContent: "space-between", marginTop: "2rem"}}>
              <div style={{height: "50%", justifyContent: "start", display: "flex", flexDirection: "column"}}>
              <div style={{display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
                <h2 className="text-2xl font-bold" style={{marginBottom: "0", lineHeight: "1"}}>User {userId}</h2>
              </div>
              <p className="text-gray-500 text-xs mb-2">
              ...
              <p className="text-gray-700" style={{paddingBottom: "24px"}}>{contents}</p>
